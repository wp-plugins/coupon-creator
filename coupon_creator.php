 ...
 * Description: This plugin creates a custom post type for coupons with a shortcode to display it on website and a single view template for printing. It also includes a button to find and insert the shortcode into the editor. 
 * Author: Brian Jessee
 * Version: 1.0	
